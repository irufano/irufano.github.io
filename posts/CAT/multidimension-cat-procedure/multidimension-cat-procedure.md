...
The **score function** (gradient), re-derived algebraically from [#4 Step 4](#step-4-ability-re-estimation) in [estimation_summary.md §0.1](/posts/cat/ability-estimation#01-pembuktian-skor-gradien-log-likelihood):
...
With a multivariate normal prior $\boldsymbol{\theta} \sim \mathcal{N}(\boldsymbol{\mu}_0, \boldsymbol{\Sigma}_0)$ (standard quadratic log-density; algebra re-derived in [estimation_summary.md §2.1](/posts/cat/ability-estimation#21-teori)):
