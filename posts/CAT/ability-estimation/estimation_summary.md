...
($P'_i$ = notasi yang sama seperti [item_selection_summary.md §0](../item_selection/item_selection_summary.md#model--notasi-dasar-dipakai-oleh-ketiga-metode)). Maka:
...
[1, Eq.2, p.276] — lihat [§0](#0-model--notasi-dasar-dipakai-oleh-ketiga-metode) untuk definisi
...
[Item Bank Snapshot](../item_selection/item_selection_summary.md#item-bank-snapshot), dengan pola
...
membuat MLE divergen, bahkan tanpa semua-benar/semua-salah literal. Lihat
[estimation_map.rs §2 (DEMO 3)](map/estimation_map.rs) untuk solusi regularisasi Bayesian.
...
[§0](#0-model--notasi-dasar-dipakai-oleh-ketiga-metode)). Magis & Raîche [3, p.4]: *"The choice of a prior distribution is
...
Sama seperti [1] pada
[item_selection_summary.md](../item_selection/item_selection_summary.md#referensi), bagian
...
[item_selection_summary.md](../item_selection/item_selection_summary.md#referensi) (di sana dipakai untuk Bab 6
